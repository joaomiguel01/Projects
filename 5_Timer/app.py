...
class MainApp(QWidget):
    def __init__(self):
        ...
        self.move(650, 300)
        self.miliseconds = QTime(0, 25, 0, 0)

        # Widgets
        self.display_label = QLabel(self, text=self.miliseconds.toString("hh:mm:ss:zzz"))
    ...
    def reset_timer(self) -> None:
        self.timer.stop()
        self.miliseconds = QTime(0, 25, 0, 0)
        self.display_label.setText(self.miliseconds.toString("hh:mm:ss:zzz"))
        self.start_button.setEnabled(True)
    
    def update_timer(self) -> None:
        if self.miliseconds <= QTime(0, 0, 0, 0):
            self.miliseconds = QTime(0, 0, 0, 0)
            self.display_label.setText("00:00:00:000")
            self.timer.stop()
            return

        self.miliseconds = self.miliseconds.addMSecs(-10)
        self.display_label.setText(self.miliseconds.toString("hh:mm:ss:zzz"))
